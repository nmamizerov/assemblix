...
export interface AgentNodeConfig {
  ...
  // Что агент отправляет в модель на голосовом входе:
  // "auto" (по умолчанию) — аудио, если оно есть и модель его принимает, иначе текст;
  // "audio" — строго аудио (ошибка, если модель не принимает); "text" — строго текст.
  audioInput?: "auto" | "audio" | "text";
