...
const Switch = React.forwardRef<
  ...
  SwitchProps
>(({ className, showIcons = true, ...props }, ref) => (
  ...
  >
    ...
    >
      {showIcons && (
        props.checked ? (
          <Moon className="h-3 w-3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-primary" />
        ) : (
          <Sun className="h-3 w-3 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-muted-foreground" />
        )
      )}
    </SwitchPrimitives.Thumb>
  </SwitchPrimitives.Root>
